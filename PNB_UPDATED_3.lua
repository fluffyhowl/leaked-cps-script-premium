takegems = true
-- int str;
-- "Don't drop gems" cheat from creative ps true/false
-- "Don't drop gems" cheat dari creative ps true/false


lonely = false
-- int str;
-- "Lonely" cheat from creativeps true/false
-- "Lonely" cheat from creativeps true/false


suckmode = false
-- int str;
-- Auto suck black gems every magplant empty true/false (still error)
-- Auto suck black gems setiap magplant emtpy true/false (masih error)


bg = 14
-- int num;
-- To get a magplant please put background block behind magplant
-- Untuk mendapatkan magplant dimohon untuk put background block di belakang magplant
...
while true do
    ...
    if count > 0 then
        ...
        if (bckpos == true) and (GetLocal().posX ~= xawal) and (GetLocal().posY ~= yawal) then
